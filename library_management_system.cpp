...
void showRecordSummary(){
    ...
    cout << "\n===== Library Record Summary =====" << endl;
    cout << "Total Book Records   : " << totalBookRecords << endl;
    cout << "Current Book Records : " << count << endl;
    cout << "Deleted Book Records : " << totalDeletedRecords << endl;
}